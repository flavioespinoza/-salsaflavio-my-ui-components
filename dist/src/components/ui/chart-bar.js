...
const ChartBar = () => {
    return (React.createElement("div", { className: "mt-6 w-full max-w-4xl" },
        React.createElement(ChartContainer, { config: chartConfig },
            React.createElement(ResponsiveContainer, { width: "100%", height: 400 },
                React.createElement(BarChart, { data: chartData, margin: { top: 20, right: 30, left: 0, bottom: 5 } },
                    React.createElement(XAxis, { dataKey: "day" }),
                    React.createElement(YAxis, null),
                    React.createElement(Tooltip, null),
                    React.createElement(Legend, null),
                    React.createElement(Bar, { dataKey: "Base Time", stackId: "a", fill: "#8dd081" }),
                    React.createElement(Bar, { dataKey: "Bonus Time", stackId: "a", fill: "#16463d" }),
                    React.createElement(Bar, { dataKey: "Referral Time", stackId: "a", fill: "#FFFFFF" }))))));
};
